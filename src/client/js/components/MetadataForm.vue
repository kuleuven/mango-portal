<template>
    ...
    <div class="formContainer">
        ...
        <div class="column big">
            <FormSchema :schema="schema" v-model="model" @submit.prevent="submit" :key="formKey" novalidate>
...
<script>
    ...
    import schemaWithPointers from '../../../metadata-schema/yoda/core/metadata.json'
    ...
    export default {
        ...
        methods: {
            ...
            // Custom validation
            validate(){
                var formDivs = document.getElementsByTagName("form")[0].getElementsByTagName("div")
                let success = true
