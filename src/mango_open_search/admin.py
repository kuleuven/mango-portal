...
def index():
    ...
    return render_template('mango_open_search/admin_index.html.j2', result=result, available_collections = home_collection.subcollections, indexing_thread_status = indexing_thread.status)
